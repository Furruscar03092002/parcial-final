...
void main(void)
{
   ...
   int boton = 0;
    ...
    while (1)
   {
     if(!PORTCbits.RC2 && boton <=100) // Mientras este encendido y este a menos de 100 de la PWM harálo siguiente
     {
     ...
     else                             // Aquí emepezará a disminuir la luz despues de alcanzar el límite  
          {
           PWM3_LoadDutyValue(boton);
           boton = boton - 1; 
           if (boton <= 0)
